...
import { MapPin, MessageCircle, MessageSquare, Clock, Info, Star, PlusCircle, Send, Trash2, X, AlertTriangle, CheckCircle, ChevronRight, Plus } from 'lucide-react';
...
const StoreDetailPage: React.FC<StoreDetailProps> = ({ 
            ...
            {showPostForm && (
              <form onSubmit={handlePostSubmit} className={`p-8 rounded-[2.5rem] border-2 animate-in zoom-in-95 duration-300 ${settings.isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-100 shadow-2xl'}`}>
                ...
                <textarea 
                  ...
                  placeholder="اكتب استفسارك، تجربتك مع المتجر..." 
